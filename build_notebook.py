"""Build the review.ipynb — загрузка данных из всех источников."""
import json
...
# === SCIGLASS: СВОЙСТВА ===
md(["## 1. SciGlass — свойства (~422k стёкол)"]),
...
# === SCIGLASS: ЭЛЕМЕНТНЫЙ СОСТАВ ===
md(["## 2. SciGlass — элементный состав"]),
...
# === SCIGLASS: ОКСИДЫ (осторожно, 726 компонентов) ===
md(["## 3. SciGlass — состав в оксидах\n",
...
# === SCIGLASS: ОБЪЕДИНЯЕМ ===
md(["## 4. Объединённый датасет SciGlass"]),
...
out = 'C:/Users/user/Documents/Great_power_great_responsibility/Ближайшее/Хакатон/review.ipynb'
with open(out, 'w', encoding='utf-8') as f:
    json.dump(nb, f, ensure_ascii=False, indent=1)
print(f'Done: {len(cells)} cells -> review.ipynb')
